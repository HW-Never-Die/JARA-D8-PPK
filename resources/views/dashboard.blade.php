<x-layouts.app>
    ...
    <div x-data="{ createModalOpen: false, editModalOpen: false, editListId: null, editListName: '', editListDesc: '', deleteModalOpen: false, deleteListId: null, deleteListName: '' }" class="space-y-8">
                            ...
                            <div>
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <div class="flex items-center gap-1.5">
                                        ...
                                        <button type="button"
                                                @click="deleteModalOpen = true; deleteListId = {{ $list->id }}; deleteListName = {{ Js::from($list->name) }}"
                                                title="Hapus daftar"
